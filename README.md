<h1>Projeto Spring Data JPA na Prática - DIO</h1>
...
<p>Conhecer os principais conceitos de mapeamento objeto relacional (ORM) usando o <strong>Spring Data JPA</strong>, através do desenvolvimento de uma <strong>API RESTful</strong> com ênfase na modelagem de suas entidades, no domínio de uma academia de ginástica.</p>
...
Projeto base disponibilizado pela [cami-la](https://www.linkedin.com/in/cami-la/ "cami-la").
